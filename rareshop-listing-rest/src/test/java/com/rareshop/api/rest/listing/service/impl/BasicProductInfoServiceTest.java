...
public class BasicProductInfoServiceTest {
    ...
    public void setUp() {
        ...
        basicProductInfoService.setRepository(repository); //@InjectMocks not used and setter used
    ...
    class AddProductInfo {
        ...
        public void addProductInfoWithoutName() throws Exception {
            ...
            Exception exception = Assertions.assertThrows(BadRequestException.class,
                    () -> basicProductInfoService.addProductInfo(basicProductInfoData));
        ...
        public void addProductInfoWithNameAndDescription() throws Exception {
            ...
            BasicProductInfoData basicProductInfoData = new BasicProductInfoData();
            basicProductInfoData.setName("Name");
            basicProductInfoData.setDescription("Description");

            Acknowledgement acknowledgement = basicProductInfoService.addProductInfo(basicProductInfoData);

            verify(repository).save(productInfoCaptor.capture());
            Assertions.assertEquals(new BasicProductInfo(basicProductInfoData),
        ...
        void updateProductInfoWithBadInfo() throws Exception {
            ...
            Assertions.assertAll(
                    () -> {
                        ...
                        Assertions.assertEquals(ErrorMessage.ID_NOT_SET, exception.getMessage());
                        verify(repository, never()).save(any(BasicProductInfo.class));
                    },
                    () -> {
                        BasicProductInfo basicProductInfo = new BasicProductInfo();
